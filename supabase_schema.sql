create table if not exists absurd_games (
  ...
  default_pack text default 'mix',
  mission_mode text default 'active',
  phase text default 'lobby',
  round_no integer default 0,
  current_case_json text default '{}',
  used_accusations_json text default '[]',
  used_evidence_json text default '[]',
...
alter table absurd_games add column if not exists default_pack text default 'mix';
alter table absurd_games add column if not exists mission_mode text default 'active';
alter table absurd_games add column if not exists used_accusations_json text default '[]';
alter table absurd_games add column if not exists used_evidence_json text default '[]';
